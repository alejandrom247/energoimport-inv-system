const generateResetPasswordEmail = (resetToken:string) => `
        ...
        <tr style="width:100%">
          <td>
                          ...
                          <td>
                            ...
                            <p
                              style="font-size:14px;line-height:24px;color:#333;font-family:-apple-system, BlinkMacSystemFont, &#x27;Segoe UI&#x27;, &#x27;Roboto&#x27;, &#x27;Oxygen&#x27;, &#x27;Ubuntu&#x27;, &#x27;Cantarell&#x27;, &#x27;Fira Sans&#x27;, &#x27;Droid Sans&#x27;, &#x27;Helvetica Neue&#x27;, sans-serif;margin:24px 0;margin-bottom:14px;margin-top:24px;margin-right:0;margin-left:0">
                                Usted ha solicitado un código de recuperación de contraseña al sistema de gestión de inventario de ENERGOIMPORT. Inserte el código siguiente cuando se le solicite por el sistema
                            </p>
                            <table
                              align="center"
                              width="100%"
            ...
            <p
             ...
             Este mensaje fue generado por el sistema de inventario ha solicitud del usuario para reiniciar su contraseña. Sino fue usted por favor verifique su seguridad
              <!-- -->
              <a
                href="http://intranet.energonet.une.cu"
